...
function ResortForm({
  ...
  const [form, setForm] = useState({
    ...
    trails_green: String(resort?.trails_green ?? ''),
    trails_blue: String(resort?.trails_blue ?? ''),
    trails_red: String(resort?.trails_red ?? ''),
    trails_black: String(resort?.trails_black ?? ''),
    freeride_rating: String(resort?.freeride_rating ?? ''),
